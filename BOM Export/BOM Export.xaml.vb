...
Public Class BOM_Export
    ...
    Private Sub textBlock_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles textBlock.MouseDown
        Dim da As New DoubleAnimation
        'da.SetValue(win_BOMExport, HeightProperty) = 275
        da.From = win_BOMExport.Width
        da.To = win_BOMExport.Width + 275
        da.AccelerationRatio = 0.8
        da.Duration = TimeSpan.FromSeconds(1)
        win_BOMExport.BeginAnimation(WidthProperty, da)
